...
function! GoToTheBaseClass()
    ...
    let extends_pattern = '^extends '
    if search(use_base_pattern, "bW") || search(use_base_pattern, "W") || search(extends_pattern, "bW") || search(extends_pattern, "W")
...
call RTKSource('go_to_base_class_mappings.vim')
